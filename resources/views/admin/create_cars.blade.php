            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h4>
                        ...
                        <span class="text-semibold">Create Cars</span>
                    </h4>
                    <ul class="breadcrumb position-right">
                        <li><a href="{{route('admin.index')}}">Home</a></li>
                        <li><a href="{{route('admin.cars.index')}}">Cars </a></li>
                        <li class="active">Create New Car</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="tab-pane fade in active" id="settings">
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h6 class="panel-title">Create new Car</h6>
                                    </div>
                                        ...
                                        <form method="POST" action="{{ route('admin.cars.store') }}">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label>Tags
                                                            <span class="text-warning">tap and enter</span>
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <input type="text"
